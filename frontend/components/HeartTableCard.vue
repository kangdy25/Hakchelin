...
<template>
  <div
    class="w-full mt-6 mb-6 bg-gradient-to-br from-[#FFF9F5] via-[#FFF3E0]/20 to-[#FFF9F5] border border-orange-100/60 rounded-[24px] p-6 shadow-[0_12px_36px_rgba(230,81,0,0.02)] transition-all duration-300"
  >
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
      ...
      <div class="flex flex-col gap-4 flex-1 min-w-0">
        ...
        <div
          class="flex flex-wrap items-center gap-3 bg-white/70 backdrop-blur-[2px] p-2.5 px-4 rounded-2xl border border-orange-100/30 w-fit"
        >
          <span class="text-sm font-black text-gray-500 uppercase tracking-wider">{{
            t("heartTable.surveyTitle")
          }}</span>
