export default {
  ...
  payment: {
    ...
    cancel_confirm: "Cancel this reservation? After the deadline, the deposit is not refunded.",
    cancel_success: "Your reservation was cancelled and points were refunded according to the policy.",
  ...
  admin: {
    ...
    menus: {
      ...
      edit: "Edit",
      delete: "Delete",
      schedule_summary: "{date} · {time} · Capacity {capacity}",
