...
<template>
  <div
    class="w-full max-w-md bg-white/80 backdrop-blur-md rounded-2xl shadow-xl overflow-hidden p-8 border border-white"
  >
    ...
    <div class="mt-8 text-center">
      <p class="text-sm text-gray-600">
        ...
        <button @click="toggleMode" class="ml-1 text-[#16a34a] font-semibold hover:underline" type="button">
