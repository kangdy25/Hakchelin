      ...
      >
        ...
        <div class="space-y-5">
          ...
          <p class="text-sm text-gray-500 font-medium leading-relaxed">
            {{
              locale === "ko"
                ? "기부할 포인트 금액을 선택하거나 직접 입력해주세요."
                : "Please select or enter the amount of points to donate."
            }}
          </p>
          ...
          <div class="grid grid-cols-2 gap-2">
            <button
              ...
              :class="{
                'bg-orange-50 text-[#E65100] border-[#E65100] ring-2 ring-orange-100': amount === preset
              }"
            >
            ...
            >
              ...
              {{
                locale === "ko"
                  ? `잔돈 전액 기부 (${restAmount.toLocaleString()}P)`
                  : `Donate remaining change (${restAmount.toLocaleString()}P)`
              }}
            </button>
          </div>
          ...
          <div class="relative">
            ...
            />
            <span class="absolute right-4 top-1/2 -translate-y-1/2 font-black text-gray-400 text-sm"> Point </span>
          </div>
