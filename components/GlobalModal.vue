...
<template>
  <div>
    ...
    <Transition name="modal-fade">
      ...
      >
        <div
          class="bg-white rounded-[24px] p-6 max-w-sm w-full shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-gray-100 flex flex-col items-center text-center transform transition-all duration-300 scale-100"
        >
          <!-- Icon by Type -->
          <div class="mb-4">
            <!-- Success Icon -->
            <div
              ...
              class="w-16 h-16 bg-green-50 text-green-500 rounded-full flex items-center justify-center text-3xl shadow-inner"
            >
              ✓
            </div>
            <!-- Error Icon -->
            <div
              ...
              class="w-16 h-16 bg-red-50 text-red-500 rounded-full flex items-center justify-center text-3xl shadow-inner"
            >
              ✕
            </div>
            <!-- Warning Icon -->
            <div
              ...
              class="w-16 h-16 bg-amber-50 text-amber-500 rounded-full flex items-center justify-center text-3xl shadow-inner"
            >
              !
            </div>
            <!-- Info Icon -->
            <div
              v-else
              class="w-16 h-16 bg-blue-50 text-blue-500 rounded-full flex items-center justify-center text-3xl shadow-inner"
            >
              i
            </div>
          </div>
